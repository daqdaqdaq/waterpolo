 ...
 * @author DAQ
 */
public class EntityListFX extends StackPane {
    ...
    public EntityListFX(Postgres db, Governed target) {
        ...
        this.filteredents = new FilteredList<EntityFX>(entfx , p -> {return true;});
...
*/  
    ...
    private boolean assesEntity(EntityFX ent){
        ...
        return (nv == null || nv.isEmpty() || ent.getName().toLowerCase().contains(nv.toLowerCase()))&&(
                (this.playercb.isSelected()&&"Player".equals(ent.getType()))||
